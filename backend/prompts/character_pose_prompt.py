...
Your task is to generate a comprehensive list of unique poses and expressions for a character based on their role and description.
...
- `poses`: A list of unique strings describing a pose and expression (e.g., 'Hands on hips, smiling confidently', 'Looking down, blushing, hands behind back', 'Pointing forward, shouting angrily').
...
Generate a list of {pose_count} unique poses and expressions for the following character:
